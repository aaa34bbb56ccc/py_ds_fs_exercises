...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 20:40:24 2017
...
def number_of_friends(user):
  """how many friends does _user_ has?"""
  user_id = user["id"]
  friend_ids = friendships[user_id]
  return len(friend_ids)  #length of friend_ids list
...
#sort the list, by num_firends, largest to smallest
...
#Keys are yesrs, values ar elists of the salaries for each tenure
